...
export const THEMES: ThemeDefinition[] = [
    {
        ...
        vars: {
            ...
            '--app-caret': '#ffffff',
            '--app-selection-bg': 'rgba(96, 165, 250, 0.42)',
    ...
    },
    {
        ...
        vars: {
            ...
            '--app-caret': '#111111',
            '--app-selection-bg': 'rgba(37, 99, 235, 0.24)',
            '--app-selection-text': '#111111',
    ...
    },
    {
        ...
        vars: {
            ...
            '--app-caret': '#566c73',
            '--app-selection-bg': 'rgba(38, 139, 210, 0.24)',
            '--app-selection-text': '#002b36',
    ...
    },
    {
        ...
        vars: {
            ...
            '--app-caret': '#839496',
            '--app-selection-bg': 'rgba(38, 139, 210, 0.38)',
            '--app-selection-text': '#fdf6e3',
