...
export default function GithubStarPill({ className = '' }: GithubStarPillProps) {
    ...
    return (
        <a
            ...
            className={`gh-pill beam-follow inline-flex items-center gap-1.5 rounded-full border border-white/10 bg-white/5 px-3 py-1.5 text-xs tracking-[0.2em] text-white/70 transition hover:border-white/20 hover:bg-white/10 hover:text-white ${className}`}
